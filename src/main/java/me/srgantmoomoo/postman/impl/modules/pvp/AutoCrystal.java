...
public class AutoCrystal extends Module {
    ...
    private void placeLogic() {
        ...
        for (Entity entity : entities) {
            ...
            if (entity == mc.player || Main.INSTANCE.friendManager.isFriend(entity.getName()) || ((EntityLivingBase) entity).getHealth() <= 0)
                continue;
            ...
            for (BlockPos blockPos : blocks) {
                ...
                if (d > damage) {
                    ...
                    if ((self > d && !(d < ((EntityLivingBase) entity).getHealth())) || self - 0.5D > mc.player.getHealth() && antiSelfPop.isEnabled())
                        continue;
